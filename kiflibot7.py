...
ki2 = LINETCR.LINE() 
ki2.login(token="EzIWZklQUjt5fv1z6gl7.UM3NxLlxVADgLmxsusBUDW.vYzoZxvagrRKNQC6pHY0+jUJ8c04tn86ENNXbrl/dR0=")
ki2.loginResult()

ki3 = LINETCR.LINE() 
ki3.login(token="EzTOEEpCcPTZTDadcP85.8OY1iJbE2cs3otqwBUM9rq.bdX5srzo2Gm1K0VxGA42Oz5pBBLYG8SQeaVR3P7f/ss=")
ki3.loginResult()

ki4 = LINETCR.LINE() 
ki4.login(token="EzaGWroRNObLVVLFGHdb.x6JXUNwTo2ABeWsGFXEkYW.ZFya5XmezciEuejH2KDY5X/t/vD46ErVwIsvknhrwcc=")
ki4.loginResult()

ki5 = LINETCR.LINE() 
ki5.login(token="EzMt06ZdlknGjwR2jRnf.iXDW3NqeZe2QwsaB0p/2tW.qcz1McuRnvz9pxEOP9g9veBgiVOcHfWPe4CLNmoFloo=")
ki5.loginResult()

ki6 = LINETCR.LINE() 
ki6.login(token="EzYtGhVbfA0VaETi5E27.ysELs5+0aaJPhSRVRuIgzW.VtJLf2gOwv8HKweiIXO5g2VvsVq3jXhUKWjTBV4ZUgE=")
ki6.loginResult()
...
admsa = "ufd1fc96a20d7cf0a8e6e8dfc117f32be"
...
def bot(op):
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
            ...
            elif msg.text in ["Bot3 Gift","B3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '4'}
                msg.text = None
                ki3.sendMessage(msg)
            elif msg.text in ["Bot4 Gift","B4 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '5'}
                msg.text = None
                ki4.sendMessage(msg)
            elif msg.text in ["Bot4 Gift","B5 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '6'}
                msg.text = None
                ki5.sendMessage(msg)
            elif msg.text in ["B6 Gift","B6 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '7'}
...
#--------------------------------------------------------
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    profile.displayName = string
                    ki5.updateProfile(profile)
                    ki5.sendText(msg.to,"��􀇔􏿿Update Names👉" + string + "â‡‡â‡‡👈")
#--------------------------------------------------------
...
#-------------Fungsi Tagall User Start---------------#
            elif msg.text in ["Dor","Nong","Yank","Tot","Crot","Tag","Tagall"]:
                group = cl.getGroup(msg.to)
...
#-----------------------------------------------
            ...
            elif msg.text in ["Hajar","Sikat","Dk.kibar","Kibar"]:
                ginfo = cl.getGroup(msg.to)
                cl.sendText(msg.to,
"█░░╦─╦╔╗╦─╔╗╔╗╔╦╗╔╗░░█\n█░░║║║╠─║─║─║║║║║╠─░░█\n█░░╚╩╝╚╝╚╝╚╝╚╝╩─╩╚╝░░█\n"
 "ASSALAMUALAIKUM\n"
